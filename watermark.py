...
class BlacklistLogitsProcessor(LogitsProcessor):
    ...
    def __call__(self, input_ids: torch.LongTensor, scores: torch.FloatTensor) -> torch.FloatTensor:
        ...
        self.counter += 1
        print("Counter {} input_ids shape {}".format(self.counter, input_ids.shape))
        ...
        for b_idx in range(input_ids.shape[0]):
            ...
            # print(sum(blacklist_ids.tolist()))
    ...
    def _calc_curr_bad_word_mask(self, scores: torch.FloatTensor) -> torch.BoolTensor:
        # print("Calling _calc_curr_bad_word_mask...")
    ...
    def _set_scores_to_inf_for_banned_tokens(
        ...
        # print("Using BlacklistLogitsProcessor...")
        if self.bl_type == "hard":
...
# giang: prefix_and_output_text -> prompt and completion
