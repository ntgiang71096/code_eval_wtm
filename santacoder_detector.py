...
from evalplus_santacoder import generate_batch_completion
from extended_watermark_processor import WatermarkDetector
from codegen.model import SantaCoder
...
def try_param(gamma, delta, pass_value, wtm_path, model, tokenizer, num_samples = None):
    ...
    no_wtm_path = 'results/evalplus_santacoder_no_watermark_3'
...
if __name__ == "__main__":
    ...
    if delta == -1:
        ...
        while l < r:
            ...
            wtm_path = 'results/evalplus_santacoder_watermark_pass_{}_{}_{}'.format(args.pass_value, int(gamma * 100), delta)
        ...
        wtm_path = 'results/evalplus_santacoder_watermark_pass_{}_{}_{}'.format(args.pass_value, int(gamma * 100), int(delta))
        print("Trying with Gamma: {}; Delta: {}, pass@{}".format(gamma, delta, args.pass_value))
        print("Saving result to folder: {}".format(wtm_path))
