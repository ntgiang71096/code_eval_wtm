...
from eval_new import generate_batch_completion
...
def calculate_pass_k(wtm_path):
    ...
    os.system("evaluate_functional_correctness {}/processed.jsonl".format(wtm_path))
...
def try_param(gamma, delta, pass_value, wtm_path, model, tokenizer, num_samples = None):
    ...
    no_wtm_path = 'results/eval_new_no_watermark_pass_10'
...
if __name__ == "__main__":
    ...
    if delta == -1:
        ...
        while l < r:
            ...
            wtm_path = 'results/eval_new_watermark_pass_{}_{}_{}'.format(args.pass_value, int(gamma * 100), delta)
        ...
        wtm_path = 'results/eval_new_watermark_pass_{}_{}_{}'.format(args.pass_value, int(gamma * 100), int(delta))
        print("Trying with Gamma: {}; Delta: {}, pass@{}".format(gamma, delta, args.pass_value))
        print("Saving result to folder: {}".format(wtm_path))
